...
' name="Message" id="Message" placeholder='Enter Your Message or any suggestion' />
  ...
  "text-gray-900 w-[70%] sm:w-[50%] bg-gradient-to-r from-teal-200 to-lime-200 hover:bg-gradient-to-l focus:ring-4 focus:outline-none font-medium rounded-lg text-lg px-5 py-3">Contribute  Us</button>
      </div>
    </div>
  )
}
